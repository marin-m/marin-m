...
* I use __Python 3.x__ and Flask/Vue.JS on a professional basis in my day job and have been working on entreprise-scale applications leveraging Linux-first system development using C, __Rust__, object-oriented patterns, transactional databases in a professional context.
