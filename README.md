...
* I use __Python 3.x__ and Flask/Vue.JS on a professional basis in my day job and have been working on entreprise-scale applications leveraging Linux-first system development using C, Lua, MySQL, __Elasticsearch/Kibana__ in a professional context.
